...
- Would have liked to have seen some validation, leaving out observations in order to check hypotheses about synchrony. They depended a lot on pairwise correlation

## Stranger methods

- For a missing month in a province, they imputed by randomly drawing incidence from the same month in the same province but different years
    - I don't think this is bad, but would have thought that a seasonal AR model could have gotten better estimates
    - On the other hand, if results are still strong despite random months being inserted around, then the relationship is probably valid
